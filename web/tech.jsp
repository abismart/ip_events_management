...
String uname = usr.substring(0,usr.length()-10);
if(usr == null)
{
...
<body translate="no">
      <sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
        ...
        <sql:query dataSource="${dbsource}" var="result">
            SELECT * from event where eventtype='tech';
        </sql:query>
    <div class="container-fluid">
		...
		<div class="col-sm-3">
			<center>
				<h2 style="padding-top:12px;"><b style="background-color:black;color:white;padding:10px;border-radius:11px;"><i class="fa fa-circle" style="font-size:24px;color:#25ee25;"></i><%=uname%></b></h2>
			</center>
		</div>
		<div class="col-sm-2">
			<center>
    ...
    <div class="box">
        <center>
        <form>
            <table cellspacing="20" cellpadding="3" bgcolor="black" style="margin-left:auto; margin-right:auto;"><h1 style="color:black;margin-top: 0px;">Events List</h1>
