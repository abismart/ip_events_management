...
<form class="login-form" action="updatedb.jsp" method="post">
<c:forEach var="row" items="${result.rows}">    
<h2 class="login-form__hdg">UPDATE EVENTS</h2>
<div class="login-form__field">
<div class="input-group">
<input class="input-group__input" id="email" value="${param.eventname}" name="ename" readonly type="text" placeholder=" " required>
<label class="input-group__label" for="email">Event Name</label>
</div>
<div class="input-group">
<input class="input-group__input" id="email" value="${row.eventtype}" name="etype" type="text" placeholder=" " required>
<label class="input-group__label" for="email">Event Type</label>
</div>
<div class="input-group">
<input class="input-group__input" id="email" value="${row.eventvenu}" name="evenu" type="text" placeholder=" " required>
<label class="input-group__label" for="email">Venue</label>
</div>    
<div class="input-group">
<input class="input-group__input" id="password" value="${row.eventtime}" name="etime" type="text" placeholder=" " required>
<label class="input-group__label" for="password">Time</label>
</div>
</div>
<input class="login-btn" type="submit" value="Update" name="add">
</c:forEach>
</form>
                </center>      </div>
        </div>
